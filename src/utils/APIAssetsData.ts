...
import { CreativeDiscoverySurface } from "../interface";

export const APIAssetsData: CreativeDiscoverySurface = {
    ...
    assets: {
      CreativeDiscoverySurface_Frontend: {
        meta: {
          revision: 1,
          headRevision: 1,
          revisedAt: DateTime.now().toISO(),
          promotion: 1,
          promotedAt: DateTime.now().toISO(),
        },
        assetData: {
          AnalyticsId: "t412",
          TestCohorts: [
